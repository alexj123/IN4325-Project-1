"""
The code in this file was used to attempt to implement another model, but was not used in the end result.

See the 'learning_to_rank_unused.py' file for the code that was used to produce the results.
"""
